...
- [tests/SourceSlots.md](tests/SourceSlots.md): Live array enqueue captured; upstream callers compact or preserve inactive slots differently. Grouped lifetime/view handoff and FG motion remain incomplete.
