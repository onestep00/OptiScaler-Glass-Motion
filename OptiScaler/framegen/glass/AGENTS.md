...
- [tests/SourceSlots.md](tests/SourceSlots.md): Array-only update diagnostic avoids empty-request exhaustion and compiles; live deployment, grouped lifetime/view handoff and FG motion remain incomplete.
