...
- [tests/SourceSlots.md](tests/SourceSlots.md): Shared-range accessor diagnostic passes forwarding tests; live wrapper and source type identified. Grouped lifetime/view handoff and FG motion remain incomplete.
