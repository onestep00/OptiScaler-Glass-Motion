...
- [tests/SourceSlots.md](tests/SourceSlots.md): Live draw/source joins and 2,254 current node/renderer/source chains verified. Temporal lifetime/view/GPU-history and MV/FG integration remain incomplete.
