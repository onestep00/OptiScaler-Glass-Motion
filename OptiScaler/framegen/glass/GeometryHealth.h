...
// pipelines that asked for a packed variant; array ready + array missing =
// ready. Draw outcomes are counted by the packed capture's prepare, and
...
enum GeometryGraftCounter : unsigned
{
    ...
    // graft variant; the draws keep the engine's motion.
    GraftRefused,
