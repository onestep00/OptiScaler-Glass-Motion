...
- [SourceSlots.md](SourceSlots.md): Producer fixture distinguishes linear and reordered arrays; same-process census saved/unloaded. Lifetime and new producer source not deployed; MV/FG incomplete; unsafe leaf stays disabled.
