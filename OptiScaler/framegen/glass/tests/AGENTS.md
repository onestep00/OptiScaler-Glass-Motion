...
- [SourceSlots.md](SourceSlots.md): Live linear-only producer and generation-4 census match 17,434 instance occurrences; recording stopped/module unloaded. Lifetime/MV/FG incomplete; unsafe leaf stays disabled.
