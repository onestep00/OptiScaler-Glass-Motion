...
- The same experiment supports hard boundary/high-opacity selection with configurable attenuation threshold and inner-edge width. Its initial 288-output comparison did not pass the combined surface/background preservation criteria. These CLI options are not implemented game-menu controls.
